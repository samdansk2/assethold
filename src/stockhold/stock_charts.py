...
from stockhold.legacy.visualization import Visualization
...
class StockCharts:
    ...
    def get_all_plot_data(self, cfg):
    ...
    def create_insider_relative_sale_chart(self, cfg):
        ...
        if plotly_group_data is None:
            plotly_group_data = plotly_data.copy()
        else:
            plotly_group_data[
                'data'] = plotly_group_data['data'] + plotly_data['data']
    ...
    def create_volume_on_balance(self, cfg):
        viz = Visualization()
    ...
    def create_volume_all_chart(self, cfg):
        ...
        cfg_plot_data = {
            ...
            'x': ['index'],
            'y': ['volume_em', 'volume_sma_em', 'volume_vwap'],
            'line': {
                'color': None
            }
        }
        layout = {
            'title': 'Volume Indicators: {}'.format(ticker),
            'xaxis': {
                'title': 'Date'
            },
            'yaxis': {
    ...
    def create_wt_price_chart(self, cfg):
        ...
        layout = {
            'title': 'Weighted Price Volume : {}'.format(ticker),
            'xaxis': {
                'title': 'Date'
            },
            'yaxis': {
